...
function showKeys() {
    var keyboard = document.getElementsByClassName('text-center');
...
$(document).keydown(function(e){
    if(!document.getElementById('myInput2').value &&
        ...
        if (e.which === 38 || e.which === 104) {
            $("#buttonForward").click();
            return false;
        } else if (e.which === 40 || e.which === 101) {
            $("#buttonBackward").click();
            return false;
        } else if (e.which === 37 || e.which === 100) {
            ...
            $("#buttonLeftArmUp").click();
            return false;
        }else if (e.which === 79) {
            $("#buttonRightArmUp").click();
            return false;
        }else if (e.which === 74) {
            $("#buttonLeftArmDown").click();
            return false;
        }else if (e.which === 75) {
            $("#buttonRightArmDown").click();
            return false;
        }else if (e.which === 85) {
            $("#buttonLeftArmOpen").click();
            return false;
        }else if (e.which === 80) {
            $("#buttonRightArmOpen").click();
            return false;
        }else if (e.which === 72) {
            $("#buttonLeftArmClose").click();
            return false;
        }else if (e.which === 76) {
            $("#buttonRightArmClose").click();
            return false;
        }else if (e.which === 77) {
            $("#buttonArmRest").click();
            return false;
            ...
            $("#buttonStandZero").click();
            return false;
        }else if (e.which === 67) {
            $("#buttonLyingBelly").click();
            return false;
        }else if (e.which === 86) {
            $("#buttonLyingBack").click();
            return false;
        }
